...
const int aes_key_optimize = 1; // if enabled,once you used a key for aes,you cant change it
                                // anymore
...
int cipher_decrypt(const char* data,
                   char* output,
                   int& len,
                   char* key); // internal interface ,exposed for test only
int cipher_encrypt(const char* data,
                   char* output,
                   int& len,
                   char* key); // internal interface ,exposed for test only
